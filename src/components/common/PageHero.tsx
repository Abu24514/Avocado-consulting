...
export function PageHero({ eyebrow, title, highlight, description }: PageHeroProps) {
  // Split the title around the highlight word/phrase so it can render in the gradient span
      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="mt-7 font-bold text-4xl leading-[1.1] sm:text-5xl lg:text-6xl text-white text-balance tracking-tight max-w-3xl mx-auto"
          >
            {highlight ? (
              <>
                {parts[0]}
