...
import { FiTrendingDown, FiZap, FiCheckCircle } from "react-icons/fi";

const impacts = [
  {
    icon: FiTrendingDown,
    title: "Less Manual Work",
    description: "Teams ka repetitive workload reduce.",
  },
  {
    icon: FiZap,
    title: "Faster Operations",
    description: "Processes faster aur consistent.",
  },
  {
    icon: FiCheckCircle,
    title: "Fewer Errors",
    description: "Manual mistakes aur duplicate work kam.",
  },
];
    ...
    <section className="bg-white py-24 md:py-32">
      <Container>
        <SectionHeading
          ...
          title="What Automation Actually Changes"
          align="center"
