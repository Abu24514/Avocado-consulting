...
import { FiEye, FiZap, FiCompass } from "react-icons/fi";

const impacts = [
  {
    icon: FiEye,
    title: "Clearer Visibility",
    description: "Know what is happening across your business.",
  },
  {
    icon: FiZap,
    title: "Faster Decisions",
    description: "Get the right insights when you need them.",
  },
  {
    icon: FiCompass,
    title: "Smarter Planning",
    description: "Plan ahead with confidence, backed by reliable data.",
  },
];

export default function BusinessImpactData() {
  return (
    <section className="bg-white py-24 md:py-32">
      <Container>
        <SectionHeading
          eyebrow="Business Impact"
          title="What Better Data Actually Changes"
          align="center"
